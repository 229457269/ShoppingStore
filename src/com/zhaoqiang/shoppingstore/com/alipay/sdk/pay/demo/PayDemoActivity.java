package com.zhaoqiang.shoppingstore.com.alipay.sdk.pay.demo;
...
/**
 * 最终用于支付功能   进行支付宝的支付功能   这个界面写的比较朴素
 * 在将来的程序中需要改进ui
 */
public class PayDemoActivity extends FragmentActivity {
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		TextView total = (TextView) findViewById(R.id.product_price);
		// 订单
//		total.setText();
		String money=getIntent().getStringExtra("totalPrices");
		//Toast.makeText(this,"sdsdsd"+,Toast.LENGTH_LONG).show();
		total.setText(money);
		orderInfo = getOrderInfo("测试的商品", "该测试商品的详细描述",money);
	}
